...
public class Converter {
    ...
    convertToMessageSendRequest(String email){
        return new MessageSendRequest(email);
    }


    public PasswordEditRequest
    convertToPasswordEditRequest(DoctorResponseDTO dto){
        return new PasswordEditRequest(dto.getId());
    }


    public PasswordEditRequest
    convertToPasswordEditRequest(PatientResponseDTO dto){
        return new PasswordEditRequest(dto.getId());
    }
